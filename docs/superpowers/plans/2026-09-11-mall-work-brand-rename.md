...
- [x] **Step 1: Add the failing frontend brand test**
...
- [x] **Step 2: Add the failing API brand test**
...
- [x] **Step 1: Replace only user-facing UI occurrences**
...
- [x] **Step 2: Replace browser metadata**
...
- [x] **Step 3: Replace API display metadata**
...
- [x] **Step 5: Commit runtime branding**
...
- [x] **Step 1: Rename README project references**
...
- [x] **Step 2: Rename Python package metadata**
...
- [x] **Step 3: Rename npm package metadata**
...
- [x] **Step 4: Rename Compose documentation and service display metadata**
...
- [x] **Step 5: Validate metadata and compatibility markers**
...
- [x] **Step 6: Commit metadata changes**
...
- [x] **Step 1: Run automated regressions**
...
- [x] **Step 2: Capture current named volume mounts**
...
- [x] **Step 4: Verify health and logs**
...
- [x] **Step 5: Perform a real browser shopping acceptance**
...
- [x] **Step 6: Final repository audit**
